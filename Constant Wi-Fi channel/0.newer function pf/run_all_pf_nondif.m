...
rmse_pf=[mean_rmse_pf1 mean_rmse_pf2 mean_rmse_pf3 mean_rmse_pf4...
         mean_rmse_pf5 mean_rmse_pf6 mean_rmse_pf7 mean_rmse_pf8];
           
ci_wifi_vlc_pf=[CI1; CI2; CI3; CI4; CI5; CI6; CI7; CI8];
           figure
           SNR=[25 30 35 40 45 50 55 60];
           plot(SNR,rmse_pf)
           
save wifi_vlc_nondif_pf rmse_pf ci_wifi_vlc_pf
