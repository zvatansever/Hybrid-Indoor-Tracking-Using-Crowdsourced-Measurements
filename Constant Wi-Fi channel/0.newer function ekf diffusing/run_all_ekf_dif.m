...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DIF_EKF_RMSE_VLC=[mean_rmse1 mean_rmse2 mean_rmse3 mean_rmse4...   %
            mean_rmse5 mean_rmse6 mean_rmse7 mean_rmse8];      %
confidence_ekf_dif=[CI1; CI2; CI3; CI4; CI5; CI6; CI7; CI8];   %

SNR=[25 30 35 40 45 50 55 60];                                           
figure
plot(SNR,DIF_EKF_RMSE_VLC)%
save wifi_vlc_dif_ekf DIF_EKF_RMSE_VLC confidence_ekf_dif       %
toc                                                            %