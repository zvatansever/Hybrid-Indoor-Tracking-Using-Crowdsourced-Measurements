...
seed_kal=0; %
vlc_noise=1.50E-12; % VLC channel noise
qx=0.05; % process noise
%%
ekf_rmse1=[];
ekf_rmse_round1=[];
%%
...
%%
vlc_noise=4.50E-13; % VLC channel noise
ekf_rmse2=[];
ekf_rmse_round2=[];
...
%%
vlc_noise=1.50E-13; % VLC channel noise
ekf_rmse3=[];
ekf_rmse_round3=[];
...
%%
vlc_noise=4.50E-14; % VLC channel noise
ekf_rmse4=[];
ekf_rmse_round4=[];
...
vlc_noise=1.50E-14; % VLC channel noise
ekf_rmse5=[];
ekf_rmse_round5=[];
...
%%
vlc_noise=4.50E-15; % VLC channel noise
ekf_rmse6=[];
ekf_rmse_round6=[];
...
%%
vlc_noise=1.50E-15; % VLC channel noise
ekf_rmse7=[];
ekf_rmse_round7=[];
...
%%
vlc_noise=4.50E-16; % VLC channel noise
ekf_rmse8=[];
ekf_rmse_round8=[];
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
random_DIF_EKF_RMSE_VLC=[mean_rmse1 mean_rmse2 mean_rmse3 mean_rmse4...   %
            mean_rmse5 mean_rmse6 mean_rmse7 mean_rmse8];      %
random_confidence_ekf_dif=[CI1; CI2; CI3; CI4; CI5; CI6; CI7; CI8];   %

SNR=[25 30 35 40 45 50 55 60];                                           
figure
plot(SNR,random_DIF_EKF_RMSE_VLC)%
save random_wifi_vlc_dif_ekf random_DIF_EKF_RMSE_VLC random_confidence_ekf_dif       %
toc                                                            %